...
export const createStyles = (theme: Theme): ReturnType<typeof StyleSheet.create> =>
  StyleSheet.create({
    ...
    szSizeValue: { fontSize: 40, fontWeight: '800', color: theme.textInverse },
    szSizeSep: { fontSize: 28, fontWeight: '400', color: theme.textInverse },
    szSizeUnit: { fontSize: 16, fontWeight: '400', color: theme.textInverse, marginLeft: 2 },
    szRationale: {
      fontSize: 12,
      color: theme.textInverse,
      lineHeight: 17,
    ...
    szMetricDivider: { width: 1, backgroundColor: theme.border },
