...
export const FRUIT_TREE_OVERRIDES: Record<string, PlantCareProfile> = {
  ...
  // ── Homestead additions (Lychee, Citron, Batoko Plum) ─────────────────
  // General horticultural figures, not TNAU-reviewed data. As for the rows
  // above, `daysToHarvest` is fruit development from bloom and the wait for a
  // first crop is `yearsToFirstHarvest` (docs/DOMAIN_LOGIC.md).
  [buildProfileKey('fruit_tree', 'Lychee')]: {
    waterRequirement: 'high',
    wateringFrequencyDays: 3,
    fertilisingFrequencyDays: 60,
    pruningFrequencyDays: 365,
    ...
    tamilName: 'லிச்சி',
    description:
      'Evergreen tree bearing clusters of red, rough-skinned fruit with sweet translucent flesh. It needs a cool, dry spell before flowering: in the Kanyakumari plains the tree grows well but often fails to bloom, and it sets fruit more reliably in the foothills. Air-layered plants bear in 3–5 years.',
    ...
    petToxicity: false,
    feedingIntensity: 'medium',
    growthStageDurations: { seedling: 180, vegetative: 1280 },
    annualCycleDurations: { flowering: 30, fruiting: 90, dormant: 245 },
    floweringStartMonth: 1,
  },
  [buildProfileKey('fruit_tree', 'Citron')]: {
    waterRequirement: 'medium',
    wateringFrequencyDays: 4,
    fertilisingFrequencyDays: 45,
    pruningFrequencyDays: 180,
    ...
    description:
      'Thorny, shrubby citrus with large, thick-rinded fruit used mostly for pickle and preserves. Grows easily from cuttings; keep the collar free of standing water, which brings on foot rot.',
    daysToHarvest: { min: 150, max: 240 },
    yearsToFirstHarvest: 3,
    heightCm: { min: 250, max: 450 },
    spacingCm: 400,
    plantingDepthCm: 25,
    growingSeason: 'Jun–Sep',
    germinationDays: { min: 0, max: 0 },
    ...
    feedingIntensity: 'medium',
    growthStageDurations: { seedling: 120, vegetative: 975 },
    annualCycleDurations: { flowering: 30, fruiting: 180, dormant: 155 },
    floweringStartMonth: 2,
  },
  [buildProfileKey('fruit_tree', 'Batoko Plum')]: {
    waterRequirement: 'medium',
    wateringFrequencyDays: 5,
    fertilisingFrequencyDays: 60,
    pruningFrequencyDays: 365,
    ...
    taxonomicFamily: 'Salicaceae',
    lifecycle: 'permanent',
    tamilName: 'பட்டோகோ பிளம்',
    description:
      'Thornless evergreen tree with glossy, toothed leaves that flush orange-red when new. Bears clusters of shiny, round, cherry-like fruit that ripen from green to red and reddish-purple; too sour to eat raw, it goes into pickles, jams and juice. Hardy once established.',
    daysToHarvest: { min: 60, max: 90 },
    yearsToFirstHarvest: 4,
    heightCm: { min: 500, max: 1500 },
    spacingCm: 600,
