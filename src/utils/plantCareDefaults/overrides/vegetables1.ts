...
export const VEGETABLE_OVERRIDES_1: Record<string, PlantCareProfile> = {
  ...
  // No care profile existed for this row, so it resolved to bare vegetable
  // defaults — no species, no season, no harvest window — while the catalog
  // described it as a cool-season crop. Peas need the mildest local months and
  // will not set pods through the monsoon heat.
  [buildProfileKey('vegetable', 'Green Peas')]: {
    waterRequirement: 'medium',
    wateringFrequencyDays: 3,
    ...
    description:
      'Short cool-season climbing legume suited to the mildest local months. Nitrogen-fixing; give it a trellis and sow only for the Oct–Feb window, as pods fail to set once nights stay warm.',
    daysToHarvest: { min: 60, max: 90 },
  ...
  [buildProfileKey('vegetable', 'Watermelon')]: {
    ...
    tamilName: 'தர்பூசணி',
    description:
      'Sprawling warm-season vine for sandy, free-draining beds. Needs full sun and room to run; ease off watering as the fruit ripens or it splits and loses sweetness.',
    daysToHarvest: { min: 75, max: 90 },
    heightCm: { min: 30, max: 45 },
    spacingCm: 150,
    plantingDepthCm: 3,
    growingSeason: 'January–March',
    germinationDays: { min: 5, max: 10 },
    ...
    petToxicity: false,
    feedingIntensity: 'medium',
    growthStageDurations: { seedling: 12, vegetative: 28, flowering: 18, fruiting: 25 },
  },
  [buildProfileKey('vegetable', 'Muskmelon')]: {
    waterRequirement: 'medium',
    wateringFrequencyDays: 3,
    fertilisingFrequencyDays: 21,
    pruningFrequencyDays: 21,
    ...
    description:
      'Trailing warm-season vine for sandy, free-draining beds. Keep the fruit off wet soil on a straw or leaf pad, and cut watering back as it nets and ripens.',
    ...
    petToxicity: false,
    feedingIntensity: 'medium',
    growthStageDurations: { seedling: 12, vegetative: 25, flowering: 16, fruiting: 22 },
  },
