...
export const PLANT_NAME_ALIASES: Record<string, string> = {
  ...
  kurkka: 'koorka',
  sirukizhangu: 'koorka',
  'plectranthus rotundifolius': 'koorka',

  // Keerai
  gongura: 'pulicha keerai',
  pulichakeerai: 'pulicha keerai',
  'roselle leaves': 'pulicha keerai',
  karisalai: 'karisalankanni keerai',
  karisalankanni: 'karisalankanni keerai',
  bhringraj: 'karisalankanni keerai',
  'false daisy': 'karisalankanni keerai',
  musumusukai: 'musumusukkai',
  musumuskkai: 'musumusukkai',
  'mukia maderaspatana': 'musumusukkai',
  ...
  elanthai: 'ilanthai',
  'indian jujube': 'ilanthai',
  ber: 'ilanthai',
  'ziziphus mauritiana': 'ilanthai',
  panai: 'palmyra',
  'panai maram': 'palmyra',
