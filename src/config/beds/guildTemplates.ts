  ...
  leafy: {
    ...
    plant_rows: [
      ...
      },
      {
        ...
        spacing_cm: 20,
        row_gap_cm: 25,
        crop_family: 'amaranthaceae',
        companion_plants: ['Radish', 'Carrot'],
        days_to_harvest: 30,
        care_tasks: ['Keep soil moist', 'Cut and come again from Day 30'],
        succession_week: 1,
      },
      {
        name: 'Fenugreek',
