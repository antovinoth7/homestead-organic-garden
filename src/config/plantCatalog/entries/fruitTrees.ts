...
export const FRUIT_TREE_ENTRIES: PlantCatalogEntry[] = [
  ...
  },
  {
    ...
    shortDescription:
      'Hardy deciduous tree producing tart, vitamin-C-rich berries revered in Ayurveda',
  ...
  },
  {
    ...
    shortDescription:
      'Tropical evergreen tree producing large spiny fruits with creamy, tangy pulp',
  },
  {
    name: 'Mangosteen',
    plantType: 'fruit_tree',
  ...
  // Tamil Nadu homestead trees. `fruit_tree` means perennial fruit crop, not
  // literally a tree — Pineapple and Passion Fruit are here already.
  {
    name: 'Tamarind',
    plantType: 'fruit_tree',
    cropFamily: 'legume',
  ...
  },
  {
    ...
    varieties: ['VRI 3', 'Vengurla 4', 'Local'],
  },
  {
    name: 'Wood Apple',
    plantType: 'fruit_tree',
