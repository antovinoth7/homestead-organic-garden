...
| B.6  | Coconut per-tree tracking (2.5) — optional `harvest_tree_number` on `JournalEntry` (not a `HarvestLog`); captured in the harvest form for coconut groves (`record_kind: 'row'`); per-tree breakdown in `HarvestHistorySection` via `groupHarvestsByTree`                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              | M      | Medium | B.3                                | ⚪ Not started                 |
...
- B.1 remaining: `EditBotanicalIdentitySection` (not created — the only open B.1 item)
